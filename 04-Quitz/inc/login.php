<form class="login-card" action="inc/main.php" method="post">
	...
	<div class ="login-item"><label for="email">E-mail:</label><input type="email" name="email" id="email" placeholder="email"/></div>
	<div class ="login-item"><label></label><button type="submit">Start</button></div>
</form>